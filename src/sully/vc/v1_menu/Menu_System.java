...
public class Menu_System {
	...
	*/
	...
	public static int MenuGet(String name)
	{
		...
		for (i = 0; i < _menuCount; i++)
		{
			if (master_menus[i].name.equalsIgnoreCase(name) // [Rafael, the Esper]	
					) return i;
		}
		error("POOOOOOOO!");
		System.exit(-1); 
	...
	String WrapText(VFont wt_font, String wt_s, int wt_linelen)
	{
		...
		String wt_tline = "";
		String wt_output = "";
		//Unused code. int wt_breaks = tokencount(wt_s, "&");
		while (len(wt_s)!=0)
		{
...
//		act = null;
	...
	// [Rafael, the Esper] Wrapper for menu calling functions
