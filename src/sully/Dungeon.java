...
public class Dungeon {
	...
	public static void Sara_event() /* 2 */
	{
		...
		entity.get(darin).obstructable = false; // [Rafael, the Esper]
		entitymove(darin,"D12"); // [Rafael, the Esper] was "D12 D0"
		WaitForEntity(darin);
		...
		entity.get(0).visible = false; // [Rafael, the Esper]
		entity.get(0).obstruction = false; // [Rafael, the Esper]
