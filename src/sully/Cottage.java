...
public class Cottage {
	...
	public static void encounter()
	{
		...
		playmusic(load("res/music/badexper.mod")); //cue DRAMATIC music.
		...
		entity.get(stan).setx(27*16);
		entity.get(galfrey).setx(28*16);
		...
		playmusic(load("res/music/cr_guit.s3m"));	//play HEARTBREAKINGLY SAD music
