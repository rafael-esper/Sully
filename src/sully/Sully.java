...
public class Sully extends VergeEngine {
	...
	public static VImage 	arTempImg[] = new VImage[MAX_SCRATCH]; // [Rafael, the Esper]
	...
	static void DoIntro()
	{
		String sav_rString = ""; // [Rafael, the Esper] current_map.renderstring;
	...
	public static boolean _title_menu_load_cancel; // [Rafael, the Esper]
	...
	public static void EntFinish() {
		...
		unpauseplayerinput(); // [Rafael, the Esper]
	}

	// [Rafael, the Esper] (These zone functions weren't in Sully class, so it is necessary to be defined here in order to be called by other maps)
